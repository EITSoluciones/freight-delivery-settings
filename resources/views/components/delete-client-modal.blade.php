...
@php
    $modalId = 'delete-client-modal-' . $client->id;
@endphp
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-neutral-primary-soft border border-default rounded-base shadow-sm p-4 md:p-6">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-6 text-body">Are you sure you want to delete this client
                    <strong>{{ $client->name ?? 'No client' }}</strong> ?
                </h3>


                <form id="deleteClientForm" action="{{ route('clients.destroy', $client) }}" method="POST">
                    @csrf
                    @method('DELETE')
