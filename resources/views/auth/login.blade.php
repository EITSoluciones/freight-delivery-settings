...
<body class=" flex p-6 lg:p-8 items-center justify-center min-h-screen flex-col">
    <div
        ...
        <main class="flex max-w-[335px] w-full flex-col-reverse lg:max-w-4xl lg:flex-row ">
            ...
            <div
                class=" h-64 relative lg:h-auto lg:-ml-px -mb-px lg:mb-0 rounded-t-lg lg:rounded-t-none lg:rounded-r-lg  w-full lg:w-[438px] shrink-0 overflow-hidden">
